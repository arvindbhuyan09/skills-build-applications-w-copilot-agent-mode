...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Add more detailed test data for users
        users = [
        ...
        # Add more detailed test data for teams
        ...
        # Add more detailed test data for activities
        activities = [
        ...
        # Add more detailed test data for leaderboard
        leaderboard_entries = [
        ...
        # Add more detailed test data for workouts
        workouts = [
